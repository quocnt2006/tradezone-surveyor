...
class CreateFloorAreaPage extends StatefulWidget {
  CreateFloorAreaPage({Key key,}) : super(key: key);

  @override
  _CreateFloorAreaPageState createState() => _CreateFloorAreaPageState();
}

class _CreateFloorAreaPageState extends State<CreateFloorAreaPage> {
        ...
        builder: (context, snapshot) {
          return RaisedButton(
            ...
            onPressed: snapshot.data == null ? () {
              ...
              Navigator.pop(context, floorArea);
            } : null,
            child: Row(
